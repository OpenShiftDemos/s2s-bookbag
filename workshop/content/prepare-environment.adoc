...
Visit https://console-openshift-console.apps.cluster-{USER_GUID}.{USER_GUID}.events.opentlc.com/[the OpenShift Console] where you will see a screen like this:
...
Congratulations! You are now logged into OpenShift 4 and have accessed your Project, where you will be working today. 
In the next section will we will build and deploy the model service. 
