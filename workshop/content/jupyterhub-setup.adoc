...
image::project-landing-page-hlt.png[width=750]
...
image::routes-jupyter-hlt.png[width=750]
__(The urls given under 'Location' in your OpenShift Project will differ from those shown in the image above.)__

This url will take you to a page asking you to 'Sign in with OpenShift'. Go ahead and click that big orange button.

image::jh-sign-in-with-os.png[width=750]

In order to access JupyterHub you need to re-authenticate with the username and password you used to login to OpenShift.

Your username is: *{USERNAME}*

Your password is: *{PASSWORD}*

This will take you to a page asking you to authorise some requested permissions. You need to click 'Allow selected permissions' to continue with the workshop. Once you've authorised access You'll see the JupyterHub Spawner Options screen:

image::jh-spawner.png[width=750]
...
image::server-spawn.png[width=750]
